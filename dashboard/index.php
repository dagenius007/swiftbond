      ...
      <div>
        <div>
          ...
          if ($_SESSION['dpay1'] == "" && $_SESSION['dpay2'] == "" && $_SESSION['dpay3'] == "") {
            ...
            if ($_SESSION['upay1v'] == "" && $_SESSION['upay2v'] == "") {
             ...
             ';
                if (isset($row3['Firstname'])) {
                  ...
                  if ($row3['upay1v'] == "11" || $row3['upay2v'] == "11") {
                    ...
                    echo '<span style="width:100px;background:rgba(206, 117, 26, 0.83);padding:4px;color:rgba(255,255,255,0.8)"><i class="fa fa-times-circle"></i> Not Verified';
                  }
                  echo '</span>';
